...
namespace ImGui
{
    ...
    IMGUI_API void          TextUnformattedWithColorMD(const char* text, const char* text_end = NULL); // allows to draw text with optional color markdown on each line (format: '$XXXXXX ')
